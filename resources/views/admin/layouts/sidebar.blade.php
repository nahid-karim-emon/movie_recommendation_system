<ul class="navbar-nav bg-gradient-dark sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <li class="nav-item">
        <a class="nav-link @if (!request()->is('admin/cast*'))
            collapsed
    ...
    <li class="nav-item">
        <a class="nav-link @if (!request()->is('admin/genre*'))
            collapsed
    ...
    <li class="nav-item">
        <a class="nav-link @if (!request()->is('admin/language*'))
            collapsed
    ...
    <li class="nav-item">
        <a class="nav-link @if (!request()->is('admin/pcompany*'))
            collapsed
    ...
    <li class="nav-item">
        <a class="nav-link @if (!request()->is('admin/director*'))
            collapsed
    ...
    <li class="nav-item">
        <a class="nav-link @if (!request()->is('admin/country*'))
            collapsed
    ...
    <li class="nav-item">
        <a class="nav-link @if (!request()->is('admin/movie*'))
            collapsed
